...
This project uses devcontainers for local development. 
...
Additionally a `postgresql` container is created as part of the devcontainer build.

Note: The devcontainer configuration is defined in the `.devcontainer` folder.
